...
<%--
 	<jsp:setProperty name="bean" property="name"/> ==> setName()만 처리
 	* => 전체 처리
 	...
 	---------------------------
 	 ...
 	 => setter
 	 	...
 	 	<jsp:useBean id="a" class="A">
 	 		= 초기화		---
 	 		<jsp:setProperty name="a" property="name" value="홍길동">    ==> name값 틀리면 오류
 	 		A a = new A()		  ---
 	 	   -- -id
 	 	 class	 
 	 	 	a.setName('홍길동')
 	 	 	...
 	 	 	a.setName(request.getParameter("name"))		//private String name;
