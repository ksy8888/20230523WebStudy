<%--
	...
	4. JSP 주로 사용하는 위치 
	   ...
	   --- JSP가 점차적으로 사라지고 있다
	   	  ...
	   	  요청 : URL을 이용해서 서버에 접근 => 요청
	   	  		--- 파일명?요청하는데이터
	   	  응답 : Servlet/JSP에서 받아서 처리후 => HTML 로 변환
	...
	3. servlet
		...
		service() ==> 브라우저에 요청한 내용에 대한 처리 => 응답할 HTML작성
			...
			= doPost()		      		  			
		  |
		destroy() ==> 파일 이동 / 새로고침 시에 자동으로 메모리 해제 (GC())
	4. JSP
	    |
