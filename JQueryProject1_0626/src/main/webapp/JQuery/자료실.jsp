...
$(function() {
	$('#addBtn').on("click",function() {
		$('#user-table').append('<tr id="m'+(fileIndex)+'">'+'<td>'+'File '+(fileIndex+1)+'<input type=file size=20>'+'</td>'+'</tr>')
		fileIndex++;
	})
			...
			<table class="table">
				...
				<td width=80%>
					<table class="table">
					 <tr>
					 	<td class="text-right">
					 	 <input type=button value="add" class="btn btn-xs btn-danger" id="addBtn">
					 	 <input type=button value="remove" class="btn btn-xs btn-success" id="removeBtn">
					 	 </td>
					 </tr>
					</table>
