...
public class FoodSearchServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<input type=hidden name=mode value=4>");		//post는 값숨겨서 보내기때문에 ?안붙이고 hidden으로 보냄
		...
		{
			out.println("<li "+(curpage==i?"class=active":"")+"><a href=MainServlet?mode=4&page="+i+">"+i+"</a></li>");
		}
		out.println("<li><a href=#>&gt;</a></li>");
		out.println("</ul>");
		out.println("</div>");
