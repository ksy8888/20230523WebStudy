	...
	public static void main(String[] args) {
		...
		try {
			...
			for(int i=0; i<title.size(); i++) {
				...
				p=p.replace("&", "#");
/*
 https://mp-seoul-image-production-s3.mangoplate.com/keyword_search/meta/pictures/u_wnwxhouitspdzq.png?fit
 =around|600:400&crop=600:400;*,*&output-format
 =jpg&output-quality
 =80				
 */
				vo.setPoster(p);
