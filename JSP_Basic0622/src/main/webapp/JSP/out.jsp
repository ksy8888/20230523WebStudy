...
<%--
		...
		1) 지시자 : page / include / taglib
					...
					4. buffer : html태그를 저장하는 공간
								소스미리보기 
								=> 시용자마다 한개만 생성 (브라우저가 연결해서 읽어가는 위치)
					  ...
					  = 요청 정보
					  	...
					  	*setCharacterEncoding() : 디코딩
					  	 ...
					  	 => GET은 자동화 처리 => window10이상
					  	 	============= server.xml(한글처리,포트)
					  	 	8080은 프록시서버 
					  = 추가 정보 (MVC,MV) => 오라클에서 받은 값을 추가 => JSP
