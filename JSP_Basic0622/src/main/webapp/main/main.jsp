...
if(mode==null)
	mode="0";
String jsp = "";
int index = Integer.parseInt(mode); //mode int형으로 변환
	...
	<div class="container">
		...
		<div class="row row1">
			<div class="col-sm-4">
			 ...
			 <table class="table">
			  <tr height="35">
			   <td class="text-center"><a href="main.jsp?mode=1">Home</a></td>
			  </tr>	
			  <tr height="35">
			  ...
			  <tr height="35">
			   <td class="text-center"><a href="main.jsp?mode=8">액션 태그</a></td>
			  </tr>
			 </table>
			</div>
			<div class="col-sm-8">
