...
public class AdminPageModel {
	...
	//이동 => request 전송(return .jsp) = forward / 미전송
	public String admin_notice(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("adminpage_jsp", "../adminpage/notice_list.jsp"); //main위에 admin올리고 그 위에 notice_list올려준
		request.setAttribute("main_jsp", "../adminpage/adminpage_main.jsp");	//전체 기반은 main
		CommonModel .commonRequestData(request);
		return "../main/main.jsp";
	}
	...
	request.setAttribute("adminpage_jsp", "../adminpage/notice_insert.jsp"); //main위에 admin올리고 그 위에 notice_list올려준
		request.setAttribute("main_jsp", "../adminpage/adminpage_main.jsp");	//전체 기반은 main
		CommonModel .commonRequestData(request);
		return "../main/main.jsp";
	}
