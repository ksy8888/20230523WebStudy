...
<%--
	...
	2) 서버 
		=> Front Controller (DispatcherServlet)
			사용자로부터 요청을 받아서 모델을 찾고 모델에서 request/session에 담아준 데이터를 JSP로 전송하는 역할
			----------------------------------------------------------------------------
			배달부 (Dispatcher)
		=> 모델 : request가 JSP전송
				 -------
				 request.setAttribute(): 데이터를 추가해서 전송할 목적
		=> JSP에서는 request에 들어가있는 데이터를 출력하기 쉽게 표현식 제공
	  ...
	  <main class="container clear"> 
	    <div class="row">
	      <table class="table">
	        ...
	        <tr>
	         <td><span style="color:green;font-size:8px">첫구매 할인가</span>&nbsp;<span style="color:green;">${vo.goods_first_price}</span></td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	          <td colspan="text-right">
	          </td>
	        </tr>
	        <tr>
	         <td class="inline">
	           <input type=button class="btn btn-lg btn-success" value="장바구니" style="width:200px;">
	           <input type=button class="btn btn-lg btn-info" value="바로구매" style="width:200px;">
	         </td>
	        </tr>
	      </table>
	    </div>
