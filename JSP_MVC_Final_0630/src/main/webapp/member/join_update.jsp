...
$(function() {
	...
	$('#postBtn').click(function() {
		Shadowbox.open({
			content:'../member/postfind.do',  //memberModel로 가서 매칭시켜줌 //우편번호검색의 화면을 보여달라_요청
			player: 'iframe',	//iframe >> include  //Model에서 받은 postfind.jsp가 여기 들어감
			width: 500,
			height: 350,
			title: '우편번호 검색'
		})
...
<body>
	<div class="wrapper row3">
	  <main class="container clear">
	  	  ...
	  	  <div class = "row">
	  	  <form method="post" action="../member/join_update_ok.do" name="joinFrm" id="joinFrm">
	  	   <table class="table">
	  	   	<tr>
	  	   	 <th class="text-right" width=15%>ID</th>
	  	   	 <td width=90% class="inline">
	  	   	  <input type=text name=id id=id size=20 class="input-sm" readonly value="${vo.id }">	  	   	 
	  	   	 </td>
	  	   	</tr>
	  	   	...
	  	   	<tr>
	  	   	 ...
	  	   	 <td width=90% class="inline">
	  	   	  <input type=text name=addr1 id=addr1 size=55 class="input-sm" readonly  value="${vo.addr1 }">
	  	   	 </td>
	  	   	</tr>
	  	   	<tr>
	  	   	...
	  	   	<tr>
	  	   	 ...
	  	   	 <td width=90% class="inline">
	  	   	  ...
	  	   	  <input type=text name=phone id=phone size=12 class="input-sm"  value="${vo.phone }">
	  	   	...
	  	   	<tr>
	  	   	 <td colspan="2" class="text-center">
	  	   	  <input type= "button" value="회원수정" class="btn btn-success btn-sm" id="joinBtn">
