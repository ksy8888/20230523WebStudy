	      ...
	      <td width=35% rowspan="2" class="info">
	       <table class="table">
	         ...
	         <tr>
	          ...
	          <tr>
	           <td colspan="2">
	             <span style="color:gray; display:none;" id="fd">예약일: </span>
	             <span id="food_day"></span>
	           </td>
	         </tr>
	         <tr>
	           <td colspan="2">
	             <span style="color:gray; display:none;" id="ft">예약시간: </span>
	             <span id="food_t"></span>
	           </td>
	         </tr>
	         <tr>
		 ...
		 **   inwon VARCHAR2(30) CONSTRAINT ri_inwon_nn NOT NULL,
	     ...
	     <tr>
	      <td width=35% height="120" class="warning">
	       <table class="table">
	         <caption><h3>예약 시간 정보</h3></caption>
	         <tr>
	         <td id="food_time"></td>
	         </tr>
	        </table>
