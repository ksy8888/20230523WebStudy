	  	         ...
	  	         <table class="table">
	  	           <tr>
	  	             ...
	  	             <a href="../recipe/chef_list.do?chef=${vo.chef }">
	  	              <img src="${vo.poster }" style="width:100px" class="img-circle">
	  	             </a>
	  	             </td>
	  	             <td colspan="4">	  	             
	  	           ...
	  	           <tr>
	  	            ...
	  	            <td><img src="image/mem7.png">&nbsp;${vo.mem_cont3 }</td>
	  	            <td><img src="image/mem3.png">&nbsp;${vo.mem_cont4 }</td>
	  	           </tr>
	  	         </table>
	  	       </c:forEach>
	  	     </td>
	  	  ...
	  	  <table class="table">
	  	   <tr>
	  	    <td class="text-center">
	  	      ...
	  	      <a href="../recipe/chef.do?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm btn-success">다음</a>
	  	    </td>
	  	   </tr>
	  	  </table>
	  	</div>
