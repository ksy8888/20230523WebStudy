...
#pagination .on {font-weight: bold; cursor: default;color:#777;}
 ...
 <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9449c44c1fccbca5a237f51044d305fc&libraries=services"></script>
</head>
<body>
	<div class="containter">
		<div class="row">
			<table class="table">
			 <tr>
			  <c:forTokens items="${vo.poster }" delims="^" var="img"> <%--poster를 ^구분해서 자르고 img에 담음 --%>
		...
		<div class="row">
		 <%--
		 	...
		 	-------------------- ? 대신 값을 첨부 (MyBatis)
		  --%>
			<div class="col-sm-7">	<%--12 넘어가면 아래로 내려감 --%>
				<table class="table">
				 <tr>
				  <td colspan="2">
		        ...
		        <div class="option">
		            <div>
		                <form onsubmit="searchPlaces(); return false;">
		                    키워드 : <input type="text" value="${addr3 }맛집" id="keyword" size="15"> 
